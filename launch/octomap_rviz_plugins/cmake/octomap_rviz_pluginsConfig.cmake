...
if("FALSE" STREQUAL "TRUE")
  set(octomap_rviz_plugins_SOURCE_PREFIX /tmp/binarydeb/ros-kinetic-octomap-rviz-plugins-0.2.0)
  set(octomap_rviz_plugins_DEVEL_PREFIX /tmp/binarydeb/ros-kinetic-octomap-rviz-plugins-0.2.0/obj-x86_64-linux-gnu/devel)
  ...
  set(octomap_rviz_plugins_INSTALL_PREFIX /opt/ros/kinetic)
...
if(NOT "include " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'octomap_rviz_plugins' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/opt/ros/kinetic/${idir}'.  ${_report}")
    endif()
    _list_append_unique(octomap_rviz_plugins_INCLUDE_DIRS ${include})
  endforeach()
endif()

set(libraries "octomap_rviz_plugins")
...
foreach(depend ${depends})
  ...
  list(APPEND octomap_rviz_plugins_EXPORTED_TARGETS ${${octomap_rviz_plugins_dep}_EXPORTED_TARGETS})
endforeach()
